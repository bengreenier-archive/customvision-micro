...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.InlineResponse2004Token();
  });
  ...
  describe('InlineResponse2004Token', function() {
    it('should create an instance of InlineResponse2004Token', function() {
      // uncomment below and update the code to test InlineResponse2004Token
      //var instane = new TrainingApi.InlineResponse2004Token();
      //expect(instance).to.be.a(TrainingApi.InlineResponse2004Token);
    });
