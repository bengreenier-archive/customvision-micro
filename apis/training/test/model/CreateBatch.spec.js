...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.CreateBatch();
  });
  ...
  describe('CreateBatch', function() {
    it('should create an instance of CreateBatch', function() {
      // uncomment below and update the code to test CreateBatch
      //var instane = new TrainingApi.CreateBatch();
      //expect(instance).to.be.a(TrainingApi.CreateBatch);
    });
