...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.ImportBatch();
  });
  ...
  describe('ImportBatch', function() {
    it('should create an instance of ImportBatch', function() {
      // uncomment below and update the code to test ImportBatch
      //var instane = new TrainingApi.ImportBatch();
      //expect(instance).to.be.a(TrainingApi.ImportBatch);
    });
