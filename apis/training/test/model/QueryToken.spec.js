...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.QueryToken();
  });
  ...
  describe('QueryToken', function() {
    it('should create an instance of QueryToken', function() {
      // uncomment below and update the code to test QueryToken
      //var instane = new TrainingApi.QueryToken();
      //expect(instance).to.be.a(TrainingApi.QueryToken);
    });
