...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateBatch', 'model/ImportBatch', 'model/InlineResponse200', 'model/InlineResponse2001', 'model/InlineResponse2002', 'model/InlineResponse2003', 'model/InlineResponse2004', 'model/InlineResponse2005', 'model/InlineResponse2006', 'model/InlineResponse2007', 'model/InlineResponse2008', 'model/InlineResponse2008Tags', 'model/QueryToken', 'model/UpdatedIteration', 'model/UpdatedProject', 'model/UpdatedTag'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateBatch'), require('../model/ImportBatch'), require('../model/InlineResponse200'), require('../model/InlineResponse2001'), require('../model/InlineResponse2002'), require('../model/InlineResponse2003'), require('../model/InlineResponse2004'), require('../model/InlineResponse2005'), require('../model/InlineResponse2006'), require('../model/InlineResponse2007'), require('../model/InlineResponse2008'), require('../model/InlineResponse2008Tags'), require('../model/QueryToken'), require('../model/UpdatedIteration'), require('../model/UpdatedProject'), require('../model/UpdatedTag'));
  } else {
    // Browser globals (root is window)
    if (!root.TrainingApi) {
      root.TrainingApi = {};
    }
    root.TrainingApi.DefaultApi = factory(root.TrainingApi.ApiClient, root.TrainingApi.CreateBatch, root.TrainingApi.ImportBatch, root.TrainingApi.InlineResponse200, root.TrainingApi.InlineResponse2001, root.TrainingApi.InlineResponse2002, root.TrainingApi.InlineResponse2003, root.TrainingApi.InlineResponse2004, root.TrainingApi.InlineResponse2005, root.TrainingApi.InlineResponse2006, root.TrainingApi.InlineResponse2007, root.TrainingApi.InlineResponse2008, root.TrainingApi.InlineResponse2008Tags, root.TrainingApi.QueryToken, root.TrainingApi.UpdatedIteration, root.TrainingApi.UpdatedProject, root.TrainingApi.UpdatedTag);
  }
}(this, function(ApiClient, CreateBatch, ImportBatch, InlineResponse200, InlineResponse2001, InlineResponse2002, InlineResponse2003, InlineResponse2004, InlineResponse2005, InlineResponse2006, InlineResponse2007, InlineResponse2008, InlineResponse2008Tags, QueryToken, UpdatedIteration, UpdatedProject, UpdatedTag) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} projectId The project id.
     * @param {module:model/ImportBatch} importBatch Image and tag ids
     ...
     * Adds the provided images to the current project iteration
     * @param {String} projectId The project id.
     * @param {module:model/CreateBatch} createBatch Image urls and tag ids
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2008Tags} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/InlineResponse2008Tags}
     */
    this.createTag = function(projectId, name, opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'text/json', '', ''];
      var returnType = InlineResponse2008Tags;
    ...
    /**
     * @param {String} projectId 
     * @param {module:model/QueryToken} queryToken 
     ...
     * @param {module:model/UpdatedIteration} updatedIteration The updated iteration model
     ...
     * @param {module:model/UpdatedProject} updatedProject The updated project model
     ...
     * @param {module:model/UpdatedTag} updatedTag The updated tag model
