...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TrainingApi.QueryToken = factory(root.TrainingApi.ApiClient);
  }
  ...
  /**
   * The QueryToken model module.
   * @module model/QueryToken
   * @version 1.0
   */

  /**
   * Constructs a new <code>QueryToken</code>.
   * @alias module:model/QueryToken
   * @class
   */
  ...
  /**
   * Constructs a <code>QueryToken</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/QueryToken} obj Optional instance to populate.
   * @return {module:model/QueryToken} The populated <code>QueryToken</code> instance.
   */
  ...
  /**
   * @member {module:model/QueryToken.OrderByEnum} OrderBy
   */
