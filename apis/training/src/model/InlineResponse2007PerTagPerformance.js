...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TrainingApi.InlineResponse2007PerTagPerformance = factory(root.TrainingApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2007PerTagPerformance model module.
   * @module model/InlineResponse2007PerTagPerformance
   * @version 1.0
   */

  /**
   * Constructs a new <code>InlineResponse2007PerTagPerformance</code>.
   * Represents performance data for a particular tag in a trained iteration
   * @alias module:model/InlineResponse2007PerTagPerformance
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2007PerTagPerformance</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2007PerTagPerformance} obj Optional instance to populate.
   * @return {module:model/InlineResponse2007PerTagPerformance} The populated <code>InlineResponse2007PerTagPerformance</code> instance.
   */
