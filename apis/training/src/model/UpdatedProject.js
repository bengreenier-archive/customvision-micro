...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TrainingApi.UpdatedProject = factory(root.TrainingApi.ApiClient, root.TrainingApi.ProjectsSettings);
  }
  ...
  /**
   * The UpdatedProject model module.
   * @module model/UpdatedProject
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdatedProject</code>.
   * Represents a project
   * @alias module:model/UpdatedProject
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdatedProject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatedProject} obj Optional instance to populate.
   * @return {module:model/UpdatedProject} The populated <code>UpdatedProject</code> instance.
   */
