...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TrainingApi.InlineResponse2004Token = factory(root.TrainingApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2004Token model module.
   * @module model/InlineResponse2004Token
   * @version 1.0
   */

  /**
   * Constructs a new <code>InlineResponse2004Token</code>.
   * @alias module:model/InlineResponse2004Token
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2004Token</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2004Token} obj Optional instance to populate.
   * @return {module:model/InlineResponse2004Token} The populated <code>InlineResponse2004Token</code> instance.
   */
  ...
  /**
   * @member {module:model/InlineResponse2004Token.OrderByEnum} OrderBy
   */
