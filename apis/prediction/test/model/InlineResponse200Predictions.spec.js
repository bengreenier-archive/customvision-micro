...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEndpoint.InlineResponse200Predictions();
  });
  ...
  describe('InlineResponse200Predictions', function() {
    it('should create an instance of InlineResponse200Predictions', function() {
      ...
      //var instane = new PredictionEndpoint.InlineResponse200Predictions();
      //expect(instance).to.be.a(PredictionEndpoint.InlineResponse200Predictions);
    });
