...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEndpoint.ImageTagPrediction();
  });
  ...
  describe('ImageTagPrediction', function() {
    it('should create an instance of ImageTagPrediction', function() {
      ...
      //var instane = new PredictionEndpoint.ImageTagPrediction();
      //expect(instance).to.be.a(PredictionEndpoint.ImageTagPrediction);
    });
